...
namespace constants
{
    ...
    const cv::Mat ARUCO_SHARPEN_KERNEL_EDGES         = (cv::Mat_<double>(3, 3) << 0, -1, 0, -1, 5, -1, 0, -1, 0);
    const cv::Mat ARUCO_SHARPEN_KERNEL_CORNERS       = (cv::Mat_<double>(3, 3) << -1, -1, -1, -1, 9, -1, -1, -1, -1);
